...
func Example_streamAggregateTypeEvents() {
	...
	// When
	PrintError(
		inMemoryStore.Save(rangedbtest.ThingWasDone{ID: "dce275e43137467b92c9f4eb6c9c77a3", Number: 100}, nil),
		inMemoryStore.Save(rangedbtest.AnotherWasComplete{ID: "594c68cfa7944f9b94afc83505ff99e9"}, nil),
		inMemoryStore.Save(rangedbtest.ThatWasDone{ID: "075d37ae85894093aa818b391442df9b"}, nil),
	)
